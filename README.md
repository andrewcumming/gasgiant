...
`envelope.py` calculates plane-parallel models of accreting envelopes (see section 3 of [Berardo et al. 2017](http://ukads.nottingham.ac.uk/abs/2017ApJ...834..149B))
